    ...
    public class ApplicantProfileRepository : IDataRepository<ApplicantProfilePoco>
    {
        ...
        public void Add(params ApplicantProfilePoco[] items)
        {
            using (SqlConnection conn = new SqlConnection(_connStr))
            {
                ...
                {
                    cmd.CommandText = @"INSERT INTO dbo.Applicant_Profiles (Id, Login, Current_Salary, Current_Rate, Currency, Country_Code, 
        ...
        public IList<ApplicantProfilePoco> GetAll(params Expression<Func<ApplicantProfilePoco, object>>[] navigationProperties)
        {
            using (SqlConnection conn = new SqlConnection(_connStr))
            {
                ...
                List<ApplicantProfilePoco> ApplicantProfilePocoList = new List<ApplicantProfilePoco>();
                while (reader.Read())
                {
                ...
                conn.Close();
                return ApplicantProfilePocoList.ToArray();
            }
        }
